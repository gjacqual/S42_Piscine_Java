...
public class Program {
	public static void main(String[] args) {
		...
		while (console.hasNext()) {
			...
			savedGrades = saveMinGrades(console, savedGrades);
			numWeek++;
			if (numWeek > 18) {
				break;
			}
	...
	private static long saveMinGrades(Scanner console, long savedGrades) {
	...
	private static void printGraph(long savedGrades) {
		for (int i = 1; i <= 18; i++) {
			...
			printColumn(gradesRemains);
			savedGrades /= 10;
		}

	}

	private static void printColumn(long gradesRemains) {
