...
public class Program {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try (HikariDataSource dataSource = hikariDataSource();
            ...
            System.out.println("Test1: page: 0, size: 3");
            List<User> all = usersRepository.findAll(0, 3);
            all.forEach(System.out::println);

            System.out.println("Test2: page: 1, size: 3");
            all = usersRepository.findAll(1, 3);
            all.forEach(System.out::println);

            System.out.println("Test3: page: 3, size: 2");
            all = usersRepository.findAll(3, 2);
            all.forEach(System.out::println);
